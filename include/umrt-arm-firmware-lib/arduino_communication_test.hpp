...
#ifndef UMRT_ARM_FIRMWARE_LIB_COMMUNICATION_TEST_HPP
#define UMRT_ARM_FIRMWARE_LIB_COMMUNICATION_TEST_HPP
...
#endif //UMRT_ARM_FIRMWARE_LIB_COMMUNICATION_TEST_HPP
